...
import { addCountry, clearSelectedCountries, removeCountry } from "@/redux/utilities";
...
const AvailableMarkets = () => {
  ...
  return (
    <Popover>
            <PopoverTrigger className="text-center w-full truncate hover:underline">Available Markets</PopoverTrigger>
